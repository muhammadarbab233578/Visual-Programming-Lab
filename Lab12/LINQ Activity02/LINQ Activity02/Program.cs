...
public class StudentClass
{
    ...
    public class Student
    {
        ...
        public List<int> ExamScores { get; set; } = new List<int>(); // Initialize the list
    }
    ...
    // Helper method to get the percentile based on average exam scores
    protected static int GetPercentile(Student s)
    {
        double avg = s.ExamScores.Average();
        return avg > 0 ? (int)(avg / 10) : 0; // Calculate percentile
    }

    // Method to query high scores
...
public class Program
{
    public static void Main()
    {
        ...
        sc.QueryHighScores(1, 90); // Query for students who scored more than 90 in the second exam
